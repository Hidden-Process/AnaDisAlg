 ...
 * frente a otros métodos de ordenación
 * 
 */
...
public class TestsTiempos {
	...
	public static void testResolverTodos(GeneradorVector<Integer> generador, String subtitulo) {
		...
		int numTests = 20; //nï¿½mero de tests para cada tamaï¿½o
		int minTam = 0, maxTam = 2000, saltoTam = 25; //tamaï¿½os mï¿½nimos, mï¿½ximos y saltos
